...
There are doubles, dates, and characters.
...
# 11. include jitter layer (I put it first so the bloxplots would be in the front)
# 12. change the color and transparency of jitter layer
# 13. remove outliers
