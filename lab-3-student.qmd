...
library(tidyverse)
=======
library(tidyverse)  # add command to hide output
>>>>>>> bf21c0a4af8fa0cd2d08fb6023c20614fc572954
```
...
=======
  geom_point(aes(x= weight, y= hindfoot_length, alpha = 0.5))+  # add space around +, also should alpha be in aes?
  facet_wrap(~ species, ncol = 5 )+
>>>>>>> bf21c0a4af8fa0cd2d08fb6023c20614fc572954
...
=======
ggplot(surveys)+ #can you add aes() here so you do not have to repeat them?
